      ...
      <div className="max-w-5xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            Discover your CO₂e footprint, see how you compare to global targets, and get
            personalized, actionable steps to reduce your impact.
          </p>
        </div>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              <div className="flex justify-between text-xs font-medium text-slate-400 mb-2">
                {STEPS.map((s, i) => (
                  <span key={s} className={i <= step ? "text-emerald-400" : ""}>
                    {s}
                  </span>
                ))}
              </div>
                  ...
                  <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                    <div className="space-y-4">
                      <div className="flex justify-between">
                        ...
                        <span className="text-emerald-400 font-bold">
                          {inputs.transport.carMilesPerWeek} mi
                        </span>
                      </div>
                      <Slider
                        aria-label="Car travel in miles per week"
                        ...
                        onValueChange={(v) =>
                          setInputs({
                            ...inputs,
                            transport: { ...inputs.transport, carMilesPerWeek: v[0] },
                          })
                        }
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between">
                        ...
                        <span className="text-emerald-400 font-bold">
                          {inputs.transport.flightsPerYear} flights
                        </span>
                      </div>
                      <Slider
                        ...
                        onValueChange={(v) =>
                          setInputs({
                            ...inputs,
                            transport: { ...inputs.transport, flightsPerYear: v[0] },
                          })
                        }
                        className="[&>span]:bg-emerald-500"
                      />
                  ...
                  <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                    <div className="space-y-4">
                      <div className="flex justify-between">
                        ...
                        <span className="text-yellow-400 font-bold">
                          {inputs.energy.electricityKwhPerMonth} kWh
                        </span>
                      </div>
                      <Slider
                        aria-label="Electricity consumption in kWh per month"
                        ...
                        onValueChange={(v) =>
                          setInputs({
                            ...inputs,
                            energy: { ...inputs.energy, electricityKwhPerMonth: v[0] },
                          })
                        }
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between">
                        ...
                        <span className="text-yellow-400 font-bold">
                          {inputs.energy.peopleInHousehold}
                        </span>
                      </div>
                      <Slider
                        ...
                        onValueChange={(v) =>
                          setInputs({
                            ...inputs,
                            energy: { ...inputs.energy, peopleInHousehold: v[0] },
                          })
                        }
                        className="[&>span]:bg-yellow-500"
                      />
                      <p className="text-xs text-slate-500">
                        Your energy footprint is divided by the number of people sharing the home.
                      </p>
                    </div>
                  </div>
                )}
                  ...
                  <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                    <div className="space-y-3">
                      ...
                      <Select
                        ...
                        onValueChange={(v: DietType) =>
                          setInputs({ ...inputs, diet: { dietType: v } })
                        }
                      >
                        ...
                        <SelectContent className="bg-slate-900 border-slate-800 text-white">
                          ...
                          <SelectItem value="meat_low">
                            Meat low (Less than 1 portion a day)
                          </SelectItem>
                          <SelectItem value="pescatarian">
                            Pescatarian (Fish but no meat)
                          </SelectItem>
                          <SelectItem value="vegetarian">
                            Vegetarian (Dairy/eggs but no meat/fish)
                          </SelectItem>
                ...
                {step === 3 && (
                  <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                    <div className="space-y-4">
                      <div className="flex justify-between">
                        <Label className="text-slate-200 text-base">
                          Monthly spend on goods/services (₹)
                        </Label>
                        <span className="text-indigo-400 font-bold">
                          ₹{inputs.shopping.shoppingSpendPerMonth}
                        </span>
                      </div>
                      <Input
                        aria-label="Monthly spend on goods and services"
                        type="number"
                        ...
                        onChange={(e) =>
                          setInputs({
                            ...inputs,
                            shopping: { shoppingSpendPerMonth: Number(e.target.value) },
                          })
                        }
                      />
                      <p className="text-xs text-slate-500">
                        Includes clothing, electronics, subscriptions, etc.
                      </p>
                    </div>
                  </div>
                )}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card className="col-span-1 bg-slate-900 border-slate-800 flex flex-col items-center justify-center p-8 text-center relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-slate-400 font-medium mb-2 uppercase tracking-widest text-sm">
                      Your Grade
                    </h3>
                    ...
                    <div className="text-4xl font-bold text-emerald-400 tabular-nums">
                      {result.totalKg.toLocaleString()}{" "}
                      <span className="text-lg text-slate-400 font-normal">kg CO₂e</span>
                    </div>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-bold text-white">
                          {result.totalKg.toLocaleString()} kg
                        </span>
                      </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="w-full bg-slate-800 rounded-full h-3 relative">
                        <div
                          className="bg-blue-500/50 h-3 rounded-full"
                          style={{ width: "14.72%" }}
                        />
                        {result.totalKg <= 1472 && (
                          <Badge className="absolute -top-6 right-0 bg-emerald-500/20 text-emerald-400 text-[10px] border-emerald-500/30">
                            Below Average!
                          </Badge>
                        )}
                      </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="w-full bg-slate-800 rounded-full h-3">
                        <div
                          className="bg-orange-500/50 h-3 rounded-full"
                          style={{ width: "47.68%" }}
                        />
                      </div>
                    </div>
                ...
                {isGenerating ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {result.actions.map((action, i) => (
                      <Card
                        key={action.id}
                        className="bg-slate-900 border-slate-800 hover:border-slate-700 transition-colors flex flex-col"
                      >
